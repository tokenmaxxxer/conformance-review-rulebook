...
[`docs/specs/state-machine.md`](specs/state-machine.md): the `review` role's
carrying artifact, its four states, its one gated transition, and its
standing refusal rule.
