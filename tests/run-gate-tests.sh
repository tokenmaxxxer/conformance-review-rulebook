...
GOOD='loop_state: reported
code_under_review: abc1234
## What was done
Audited all requirements. Basis: upstream commit abc1234.
verdict: Present
...
run deny  bad-verdict     record-fields-gate.sh "$REC" 'loop_state: reported
## What was done
x — upstream basis abc1234
verdict: LGTM'
run deny  incorrect-needs-svb record-fields-gate.sh "$REC" 'loop_state: reported
## What was done
x — upstream basis abc1234
verdict: Incorrect'
